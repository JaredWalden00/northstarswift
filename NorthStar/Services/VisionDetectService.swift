...
/// On-device object detection using Apple's Vision framework.
/// Combines multiple detectors: image classification, face detection,
/// barcode detection, and rectangle detection.
/// Returns results in the same DetectResponse format as the server API.
